  ...
  render(){
    ...
    return(
        ...
        <Grid container direction="column" item xs={12} key={this.props.video.link}>
          ...
          <Grid item  >
          <a href={this.props.video.link} className="nostyle" target="_blank" rel="noopener noreferrer">
            <Grid container direction="row" justify="center" alignItems="center">
                                        <img src="vimeo.svg" width="50" height="50" className="spin" alt="vimeo icon"></img>
